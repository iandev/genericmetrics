...
// 2018-06-16 05:35:41.545263949 -0400 EDT m=&#43;0.001972431
package metrics
...
func (m Baz) Inc() {
	...
	opts := prometheus.CounterOpts{Name: "Baz", Help: "BazHELP"}
	prometheus.NewCounterVec(opts, labels).WithLabelValues(
		m.Baz,
	).Inc()
}
...
func (m BazBar) Inc() {
	...
	opts := prometheus.CounterOpts{Name: "BazBar", Help: "BazBarHELP"}
	prometheus.NewCounterVec(opts, labels).WithLabelValues(
		m.Baz,
		m.Bar,
	).Inc()
...
func (m BarBing) Inc() {
	...
	opts := prometheus.CounterOpts{Name: "BarBing", Help: "BarBingHELP"}
	prometheus.NewCounterVec(opts, labels).WithLabelValues(
		m.Bar,
		m.Bing,
	).Inc()
