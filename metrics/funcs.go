...
// 2018-06-16 03:42:16.986915297 -0400 EDT m=&#43;0.001893936
package metrics
...
func (m BarBazBing) Inc() {
	...
	opts := prometheus.CounterOpts{Name: "BarBazBing", Help: ""}
...
func (m Baz) Inc() {
	...
	opts := prometheus.CounterOpts{Name: "Baz", Help: ""}
	prometheus.NewCounterVec(opts, labels).WithLabelValues(
		m.Baz,
	).Inc()
}
...
func (m BazBar) Inc() {
	...
	opts := prometheus.CounterOpts{Name: "BazBar", Help: ""}
	prometheus.NewCounterVec(opts, labels).WithLabelValues(
		m.Baz,
		m.Bar,
	).Inc()
...
func (m BarBing) Inc() {
	...
	opts := prometheus.CounterOpts{Name: "BarBing", Help: ""}
	prometheus.NewCounterVec(opts, labels).WithLabelValues(
		m.Bar,
		m.Bing,
	).Inc()
