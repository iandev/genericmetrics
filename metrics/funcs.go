...
// 2018-06-17 00:44:11.832505543 -0400 EDT m=&#43;0.002632210
package metrics
...
func NewBarBazBingCounter(m *BarBazBing) Counter {
	labels := []string{
		"Bar",
		"Baz",
		"Bing",
...
func (c BarBazBingCounter) Add(a float64) {
	c.c.Add(a)
}
...
func NewBazBarCounter(m *BazBar) Counter {
	labels := []string{
		"Baz",
		"Bar",
	}
...
// Add is a wrapper around the prometheus Add(float64) method
func (c BazBarCounter) Add(a float64) {
	c.c.Add(a)
}
...
func NewBarBingCounter(m *BarBing) Counter {
	labels := []string{
		"Bar",
		"Bing",
	}
...
// Add is a wrapper around the prometheus Add(float64) method
func (c BarBingCounter) Add(a float64) {
	c.c.Add(a)
}
